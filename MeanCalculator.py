...
def button_equal():
    ...
    answers = ['Use your brain dummy!', 'It isn\'t even hard!', 'It might be pi', 'Use a pencil and paper',
               'Use a calculator next time!', 'Ask your parents', 'Ask your teacher', 'Leave me alone',
               'I\'m tired right now', 'Math is boring', 'Take a nap', 'Im asleep right now',
               'Stop wasting your time', 'School is useless', 'Go watch tv', 'Science is better', 'I have no clue']

    if math == 'addition':
        e.insert(0, random.choice(answers))
